...
public sealed class ConfigurationSettingsEndpointsTests : IDisposable
{
    ...
    public async Task GetConfigurationRetentionSettings_ReturnsNotOverridden_WhenNoOverrideSet()
    {
        ...
        var response = await client.GetAsync("/api/v1/configurations/test-config/settings/retention");

        response.StatusCode.Should().Be(HttpStatusCode.OK);
        var dto = await response.Content.ReadFromJsonAsync<ConfigurationRetentionDto>();
    ...
    public async Task GetConfigurationRetentionSettings_ReturnsNotFound_WhenConfigDoesNotExist()
    {
        ...
        var response = await client.GetAsync("/api/v1/configurations/nonexistent-config/settings/retention");
    ...
    public async Task UpdateConfigurationRetentionSettings_PersistsOverrides()
    {
        ...
        var getResponse = await client.GetAsync("/api/v1/configurations/test-config/settings/retention");
        getResponse.StatusCode.Should().Be(HttpStatusCode.OK);
        var dto = await getResponse.Content.ReadFromJsonAsync<ConfigurationRetentionDto>();
        dto.Should().NotBeNull();
    ...
    public async Task UpdateConfigurationRetentionSettings_PartialUpdate_LeavesOtherFieldsUnchanged()
    {
        ...
        await client.PutAsJsonAsync("/api/v1/configurations/test-config/settings/retention",
            new UpdateConfigurationRetentionRequest { KeepVersions = 7, KeepDays = 60 });

        // Update only KeepVersions
        var putResponse = await client.PutAsJsonAsync("/api/v1/configurations/test-config/settings/retention",
            new UpdateConfigurationRetentionRequest { KeepVersions = 3 });
        putResponse.StatusCode.Should().Be(HttpStatusCode.OK);

        var dto = await putResponse.Content.ReadFromJsonAsync<ConfigurationRetentionDto>();
        dto.Should().NotBeNull();
    ...
    public async Task UpdateConfigurationRetentionSettings_ReturnsNotFound_WhenConfigDoesNotExist()
    {
        ...
        var response = await client.PutAsJsonAsync("/api/v1/configurations/nonexistent-config/settings/retention",
            new UpdateConfigurationRetentionRequest { KeepVersions = 5 });
    ...
    public async Task DeleteConfigurationRetentionSettings_ClearsOverrides()
    {
        ...
        // Set overrides first
        await client.PutAsJsonAsync("/api/v1/configurations/test-config/settings/retention",
            new UpdateConfigurationRetentionRequest { KeepVersions = 5, KeepDays = 30 });

        // Delete overrides
        var deleteResponse = await client.DeleteAsync("/api/v1/configurations/test-config/settings/retention");
    ...
    public async Task DeleteConfigurationRetentionSettings_WhenNoneSet_ReturnsNoContent()
    {
        ...
        var response = await client.DeleteAsync("/api/v1/configurations/test-config/settings/retention");
    ...
    public async Task DeleteConfigurationRetentionSettings_ReturnsNotFound_WhenConfigDoesNotExist()
    {
        ...
        var response = await client.DeleteAsync("/api/v1/configurations/nonexistent-config/settings/retention");
