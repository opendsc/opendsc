...
public class UserEndpointsTests : IClassFixture<ServerWebApplicationFactory>
{
    ...
    public async Task GetUsers_ReturnsUserList()
    {
        ...
        var users = await response.Content.ReadFromJsonAsync<List<UserSummary>>(TestContext.Current.CancellationToken);
    ...
    public async Task GetUser_WithValidId_ReturnsUserDetails()
    {
        ...
        var users = await listResponse.Content.ReadFromJsonAsync<List<UserSummary>>(TestContext.Current.CancellationToken);
        ...
        response.StatusCode.Should().Be(HttpStatusCode.OK);
        var user = await response.Content.ReadFromJsonAsync<UserDetails>(TestContext.Current.CancellationToken);
    ...
    public async Task CreateUser_WithValidData_CreatesUser()
    {
        ...
        var user = await response.Content.ReadFromJsonAsync<UserSummary>(TestContext.Current.CancellationToken);
        user.Should().NotBeNull();
    ...
    public async Task UpdateUser_WithValidData_UpdatesUser()
    {
        ...
        var createdUser = await createResponse.Content.ReadFromJsonAsync<UserSummary>(TestContext.Current.CancellationToken);
        ...
        var updatedUser = await updateResponse.Content.ReadFromJsonAsync<UserSummary>(TestContext.Current.CancellationToken);
    ...
    public async Task SetUserRoles_WithValidData_SetsUserRoles()
    {
        ...
        var userRoles = await getRolesResponse.Content.ReadFromJsonAsync<List<RoleSummary>>(TestContext.Current.CancellationToken);
