...
{
    [Description("Number of failed logon attempts before account is locked. Use 0 to never lock out accounts (not recommended for security). Recommended value is 5-10.")]
    [Minimum(0)]
    [Maximum(999)]
    [Nullable(false)]
