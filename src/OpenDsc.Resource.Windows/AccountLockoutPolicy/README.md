...
|-----------------------------------|---------|-----------------------|
| `lockoutThreshold`                | integer | Failed logon attempts |
|                                   |         | before lockout        |
|                                   |         | (0-999). Use 0 to     |
|                                   |         | never lock out (not   |
|                                   |         | recommended).         |
| `lockoutDurationMinutes`          | integer | Minutes account       |
|                                   |         | remains locked        |
|                                   |         | (0-99999). Use 0 to   |
|                                   |         | require admin unlock. |
| `lockoutObservationWindowMinutes` | integer | Minutes after failed  |
|                                   |         | logon before counter  |
|                                   |         | resets (0-99999).     |
|                                   |         | Must be ≤ duration.   |
