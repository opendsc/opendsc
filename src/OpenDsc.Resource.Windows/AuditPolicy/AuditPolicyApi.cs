...
internal static class AuditPolicyApi
{
    internal static AUDIT_POLICY_INFORMATION QueryAuditPolicy(Guid subcategoryGuid)
    {
    ...
    internal static void SetAuditPolicy(Guid subcategoryGuid, Guid categoryGuid, uint flags)
    {
