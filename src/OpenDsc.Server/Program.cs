...
builder.Services.AddScoped<INodeRegistrationManager, NodeService>();
builder.Services.AddScoped<INodeLcmManager, NodeService>();
builder.Services.AddScoped<INodeManager, NodeService>();
