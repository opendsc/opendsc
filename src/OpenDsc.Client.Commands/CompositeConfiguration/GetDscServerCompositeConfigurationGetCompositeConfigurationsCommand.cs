...
[Cmdlet(VerbsCommon.Get, "DscServerCompositeConfigurationGetCompositeConfigurations")]
...
public sealed class GetDscServerCompositeConfigurationGetCompositeConfigurationsCommand : DscServerCommandBase
{
    protected override void ProcessRecord()
    {
        ...
        var result = service.GetCompositeConfigurationsAsync(PipelineStopToken).GetAwaiter().GetResult();
