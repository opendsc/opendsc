...
[Cmdlet("Get", "DscServerParameterVersions")]
...
public sealed class GetDscServerParameterVersionsCommand : DscServerCommandBase
{
    ...
    protected override void ProcessRecord()
    {
        ...
        var result = service.GetVersionsAsync(ScopeTypeId, ConfigurationId, ScopeValue, CancellationToken.None).GetAwaiter().GetResult();
