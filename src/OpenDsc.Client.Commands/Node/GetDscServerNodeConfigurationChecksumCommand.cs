...
[Cmdlet(VerbsCommon.Get, "DscServerNodeConfigurationChecksum")]
...
public sealed class GetDscServerNodeConfigurationChecksumCommand : DscServerCommandBase
{
    ...
    protected override void ProcessRecord()
    {
        ...
        var result = service.GetConfigurationChecksumAsync(NodeId, PipelineStopToken).GetAwaiter().GetResult();
