...
[Cmdlet(VerbsCommon.Get, "DscServerNodeAssignableCompositeConfigurations")]
...
public sealed class GetDscServerNodeAssignableCompositeConfigurationsCommand : DscServerCommandBase
{
    protected override void ProcessRecord()
    {
        ...
        var result = service.GetAssignableCompositeConfigurationsAsync(PipelineStopToken).GetAwaiter().GetResult();
