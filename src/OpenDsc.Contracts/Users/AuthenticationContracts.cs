...
public sealed class LoginResult
{
    ...
    /// </summary>
    public bool RequirePasswordChange { get; internal set; }
}
...
public sealed class TokenCreationResult
{
    ...
    /// </summary>
    public string TokenPrefix { get; internal set; } = string.Empty;
...
public sealed class TokenMetadata
{
    ...
    /// </summary>
    public DateTimeOffset? LastUsedAt { get; internal set; }
